...
const clearSessionCookies = (cookies: Parameters<RequestHandler>[0]["cookies"]) => {
	...
	cookies.delete("__Secure-invoice-generator.session_token", { path: "/", secure: true });
	cookies.delete("invoice-generator.session_token", { path: "/" });
	cookies.delete("__Secure-invoice-generator.session_data", { path: "/", secure: true });
	cookies.delete("invoice-generator.session_data", { path: "/" });
};
