...
<script lang="ts">
	...
	const suggestions = [
		{
			icon: TrendingUp,
			title: "show this month's revenue",
			desc: "see the running total",
			query: "Show this month's revenue"
		},
		{
			icon: Users,
		...
		{ icon: HelpCircle, title: "what can I do here?", desc: "see what's possible", query: "What can I do here?" }
	];
</script>
