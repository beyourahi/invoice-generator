			...
			>
				...
				<div class="border-hair border-t p-1.5">
					<a
						...
						class="text-foreground pointer-fine:hover:bg-ink-2 focus:bg-ink-2 flex min-h-12 w-full touch-manipulation items-center gap-3 rounded-lg px-3 text-left transition-colors"
					>
					...
					<button
						...
						class={cn(
							"text-destructive pointer-fine:hover:bg-destructive/10 pointer-fine:hover:text-destructive focus:bg-destructive/10 focus:text-destructive flex min-h-12 w-full touch-manipulation items-center gap-3 rounded-lg px-3 text-left transition-colors disabled:cursor-not-allowed disabled:opacity-60",
				...
				<Tooltip.Trigger>
					{#snippet child({ props })}
						<a
							...
							{...props}
							class="sleek group border-hair bg-card pointer-fine:hover:border-foreground/30 pointer-fine:hover:bg-ink-2 focus-visible:outline-signal flex h-10 w-10 touch-manipulation items-center justify-center rounded-full border backdrop-blur-sm transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 active:scale-95"
						>
							<Settings
		...
		<Tooltip.Provider delayDuration={150}>
			<Tooltip.Root>
				<Tooltip.Trigger
					...
					aria-label="Sign out"
					class={cn(
						"sleek group flex h-10 w-10 cursor-pointer touch-manipulation items-center justify-center rounded-full border backdrop-blur-sm",
						"focus-visible:outline-signal focus-visible:outline-2 focus-visible:outline-offset-2",
						isLoggingOut
