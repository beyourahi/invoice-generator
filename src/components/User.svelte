<!--
	...
	expand name/email pill on fine pointers) sits beside dedicated Copilot settings + Sign out icon
	buttons, shown identically at every width — no mobile dialog. Positioning + the copilot-rail
	offset are owned by the navbar, not here.
-->
<script lang="ts">
