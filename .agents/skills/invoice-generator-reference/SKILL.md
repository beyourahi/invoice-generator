---
name: invoice-generator-reference
description: Detailed invoice architecture, auth, persistence, AI copilot, tooling, migrations, testing, and operational constraints. Read before changing those areas.
---
